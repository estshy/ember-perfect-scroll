...
export default Ember.Component.extend({
  ...
  didInsertElement() {
    ...
    run.schedule('afterRender', () => {
      ...
      if(this.get('scrollTop') !== 0 || this.get('scrollLeft') !== 0) {
        $(get(this, "_scrollElement")).scrollTop(this.get('scrollTop'));
        $(get(this, "_scrollElement")).scrollLeft(this.get('scrollLeft'));
